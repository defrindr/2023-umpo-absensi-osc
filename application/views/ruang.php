...
<head>
    ...
    <title>Data Ruang | <?= APPTITLE ?></title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="vstack gap-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="create-nama" maxlength="6">
                                    </div>
...
<script>
    global_category = [];
    ENDPOINTS = {
        'update': 'api/v1/ruang/update',
        'create': 'api/v1/ruang/create',
        'delete': 'api/v1/ruang/delete',
        'load': 'api/v1/ruang/get',
    }
